...
- **October 2018**: [BERT](https://arxiv.org/abs/1810.04805), another large pretrained model, designed to produce better summaries of sentences (more on this in the next chapter!)
